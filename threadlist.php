...
while($row = mysqli_fetch_assoc($result)){
    ...
    <div class="container my-4">
        <div class="jumbotron">
            ...
            <hr class="my-4">
            <p>This forum is for sharing knowledge with each others.No Spam / Advertising / Self-promote in the forums.
    ...
    <form action="' . $_SERVER["REQUEST_URI"] .'" method="post" class="my-3">
        ...
        echo '<div class="container">
            <h1>Start a Discussion</h1>
                ...
                <p class="lead">Please Log In to our website if you want to start a discussion.</p>
                </div>
            </div>
            </div>';
     }
    ...
    <div class="container">
       ...
       echo  '<div class="media my-3">
            ...
            <div class="media-body">
                ...
                <p>'. $desc .' </p>
                <p class="font-weight-bold">Asked By '. $row2['user_name'] .' at '. $thread_time . '</p>
            </div>
        </div> ';
    }
if($noResult){
    ...
    <div class="container">
      ...
      <p class="lead">Be the first person to ask a questtion.</p>
    </div>
  </div>';
}
?>
